      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Apparel", link: "/business/apparel", description: "POS systems designed for clothing and apparel stores.", icon: "styler" },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { name: "Qlub", link: "/marketplace/qlub", description: "Digital payment solutions for restaurants.", icon: "account_balance_wallet" },
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Geidia", link: "/marketplace/geidia", description: "Business management and integration services.", icon: "business_center" },
